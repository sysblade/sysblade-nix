...

{
  ...
  services.nfs.server = {
    ...
    exports = ''
      ...
      /mnt/dpool/immich 192.168.131.201(rw,no_subtree_check,no_root_squash)
      /mnt/dpool/immich 192.168.131.202(rw,no_subtree_check,no_root_squash)
      /mnt/dpool/immich 192.168.131.203(rw,no_subtree_check,no_root_squash)
